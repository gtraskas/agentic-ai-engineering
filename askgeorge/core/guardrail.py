...
_JUDGE_INSTRUCTIONS: str = (
    ...
    "own technology, a visitor sharing their name/email/company, questions "
    "about salary, rates, or compensation (even insistent ones — the "
    "assistant has its own policy for those), job descriptions or role fit "
    "questions, and normal greetings, thanks, or polite small talk.\n\n"
