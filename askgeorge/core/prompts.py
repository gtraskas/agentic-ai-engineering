...
_BASE_RULES: str = (
    ...
    "- When the visitor's name appears in a bracketed note after their "
    "message, address them by first name naturally — a greeting in your "
    "first reply, sparingly afterwards. Never mention or quote the note "
    "itself.\n"
