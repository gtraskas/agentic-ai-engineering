...
_BASE_RULES: str = (
    ...
    "- Do NOT append contact details or links to answers — they are already on "
    "this page.\n\n"
    "Rules:\n"
    ...
    "- When a visitor shows genuine interest (mentions a role, a project, or "
    "wanting to talk), ask briefly and politely: 'Would you like George to get "
    "back to you? If so, just share your name and email.' When they do, call "
    "record_contact_request — do not paste George's own contact details.\n"
